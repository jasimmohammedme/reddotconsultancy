      ...
      <div id='what-we-do' className='relative h-[700px] md:h-[500px] lg:h-[600px] xl:h-[540px] w-full flex flex-col border-l   md:border-x border-b '>
         ...
         <div className='w-full h-full flex flex-row border-y'>
            <div className='w-1/2 md:w-1/3 h-full flex flex-col gap-3 p-3 md:p-5 lg:p-10 border-r '>
               ...
               <p className='text-sm md:text-base'>We provide expert social media consulting, including strategy development, content posting, branding, and page growth. </p>
            </div>
            <div className='w-1/2 md:w-1/3 h-full flex flex-col gap-3 p-3 md:p-5 lg:p-10 border-r'>
               <p className='text-lg md:text-xl font-semibold font-questrial'>Paid Advertising &  Lead Generation  </p>
               <p className='text-sm md:text-base'>We help businesses grow by creating targeted ad campaigns that drive engagement, attract quality leads, and maximize conversions. </p>
            </div>
            <div className='md:block hidden w-1/3 h-full'>
               <div className='w-full h-full flex flex-col gap-3 p-3 md:p-5 lg:p-10  '>
                  ...
                  <p className='text-sm md:text-base'>We provide full-service content creation, including photography, videography, graphic design, video editing, and photo editing. </p>
               </div>
            </div>
         </div>
         <div className='w-full h-full flex flex-row'>
            <div className='w-1/2 md:w-1/3 h-full flex flex-col gap-3 p-3 md:p-5 lg:p-10 border-b md:border-b-0 border-r'>
               ...
               <p className='text-sm md:text-base'>We provide complete graphic design and branding services, including logos, brochures, social media graphics, visiting cards, billboards, and merchandise designs. </p>
            </div>
            <div className='w-1/2 md:w-1/3 h-full flex flex-col gap-3 p-3 md:p-5 lg:p-10 border-b md:border-b-0 border-r '>
               <p className='text-base md:text-lg lg:text-xl font-semibold font-questrial'>Web Design </p>
               <p className='text-sm md:text-base'>We design and develop responsive and professional websites that enhance your brand and drive conversions.</p>
            </div>
