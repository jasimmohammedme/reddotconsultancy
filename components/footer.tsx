   ...
   return (
      <div className='w-full h-[100px] border-t border-x mt-20 px-5 flex gap-5 justify-between items-center'>
         <div className='flex items-center gap-3 md:gap-5'>
            <a href='mailto:reddotconsults@gmail.com' target='_blank' className='w-9 md:w-10 lg h-9 md:h-10 bg-black flex items-center justify-center border-2'>
            ...
            <a href='tel:+917994821608' className='w-9 md:w-10 h-9 md:h-10 bg-black flex items-center justify-center border-2  '>
            ...
            <a href='https://www.instagram.com/reddotconsultancy/' className='w-9 md:w-10 h-9 md:h-10 bg-black flex items-center justify-center border-2'>
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
